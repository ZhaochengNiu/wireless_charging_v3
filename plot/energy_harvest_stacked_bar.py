...
Dot10 = np.loadtxt('../result/DotEnergyHarvestInEachSlotFilePath10.cache')
...
Dot20 = np.loadtxt('../result/DotEnergyHarvestInEachSlotFilePath20.cache')
...
Dot30 = np.loadtxt('../result/DotEnergyHarvestInEachSlotFilePath30.cache')
...
Dot40 = np.loadtxt('../result/DotEnergyHarvestInEachSlotFilePath40.cache')
...
Dot50 = np.loadtxt('../result/DotEnergyHarvestInEachSlotFilePath50.cache')
