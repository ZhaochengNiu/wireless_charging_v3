...
Dot10 = np.loadtxt('../result/DotLatencyCostInEachSlotFilePath10.cache')
...
Dot20 = np.loadtxt('../result/DotLatencyCostInEachSlotFilePath20.cache')
...
Dot30 = np.loadtxt('../result/DotLatencyCostInEachSlotFilePath30.cache')
...
Dot40 = np.loadtxt('../result/DotLatencyCostInEachSlotFilePath40.cache')
...
Dot50 = np.loadtxt('../result/DotLatencyCostInEachSlotFilePath50.cache')
