...
Dot10 = np.loadtxt('../result/DotEnergyCostInEachSlotFilePath10.cache')
...
Dot20 = np.loadtxt('../result/DotEnergyCostInEachSlotFilePath20.cache')
...
Dot30 = np.loadtxt('../result/DotEnergyCostInEachSlotFilePath30.cache')
...
Dot40 = np.loadtxt('../result/DotEnergyCostInEachSlotFilePath40.cache')
...
Dot50 = np.loadtxt('../result/DotEnergyCostInEachSlotFilePath50.cache')
